      ...
      <div className="relative mx-auto grid max-w-7xl items-start gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-14">
        <div className="pt-2">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="mt-7 inline-flex w-full md:w-fit items-center justify-center gap-2 rounded-full px-7 py-3 text-sm font-semibold uppercase tracking-[0.18em] transition-all duration-300"
            style={{
