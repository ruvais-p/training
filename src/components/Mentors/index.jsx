...
const mentors = [
    {
        ...
        imageSrc: "/Mentors/YACS mentor 2 anil.webp",
    ...
    },
    {
        ...
        imageSrc: "/Mentors/YACS mentor 4 akshay.webp",
    ...
    },
    {
        ...
        imageSrc: "/Mentors/YACS mentor 1 febi.webp",
            ...
            <div className="relative mx-auto max-w-7xl">
                ...
                <div className="mt-24 flex flex-col items-center text-center">
                    ...
                    <MotionLink
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="mt-7 inline-flex w-full lg:w-fit items-center justify-center rounded-full px-7 py-3 text-sm font-semibold uppercase tracking-[0.18em] transition-all duration-300"
                        style={{
